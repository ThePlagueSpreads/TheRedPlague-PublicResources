...
{
    public static readonly Dictionary<TechType, System.Func<GameObject, IEnumerator>> CustomModificationsList = new();
            ...
            TechType.BoneShark, new AmalgamationSettings(new[]
                {
                    new ParasiteAttachPoint(
                        ...
                        true,
                        new[] {"Mouth"},
                        new AttachableParasite(TechType.Stalker, 2f, "Stalker_02/root/spine1_phys/spine1/spine2_phys/spine2"),
                        new AttachableParasite(TechType.Eyeye, 3f),
                        new AttachableParasite(TechType.Warper, 0.8f),
                        new AttachableParasite(TechType.Crash, 4f),
                        ...
                        new AttachableParasite(TechType.Mesmer, 4f),
                        new AttachableParasite(TechType.CaveCrawler, 4f),
                        new AttachableParasite(TechType.Jumper, 4f),
                        new AttachableParasite(TechType.Bleeder, 12f),
            ...
            TechType.Stalker, new AmalgamationSettings(new[]
                {
                    new ParasiteAttachPoint(
                        ...
                        new AttachableParasite(TechType.Peeper, 2.5f),
                        new AttachableParasite(TechType.Jellyray, 0.5f, "jelly_ray_01/root_jnt/spine1_jnt/spine2_jnt/spine3_jnt/spine4_phys/spine4_jnt/tail1_phys"),
            ...
            TechType.Sandshark, new AmalgamationSettings(new[]
                {
                    new ParasiteAttachPoint(
                        ...
                        true,
                        new string[0],
                        new AttachableParasite(TechType.Eyeye),
            ...
            TechType.CrabSquid, new AmalgamationSettings(new[]
                {
                    new ParasiteAttachPoint(
                        ...
                        true,
                        new string[0],
                        new AttachableParasite(TechType.Stalker, 0.8f, "Stalker_02/root/spine1_phys/spine1"),
                        new AttachableParasite(TechType.Eyeye, 3f),
                        new AttachableParasite(TechType.Warper, 0.5f),
            ...
            TechType.Shocker, new AmalgamationSettings(new[]
                {
                    new ParasiteAttachPoint(
                        ...
                        new AttachableParasite(TechType.Crash, 2f),
                        new AttachableParasite(TechType.Peeper, 2.5f),
                        new AttachableParasite(TechType.Jellyray, 2f, "jelly_ray_01/root_jnt/spine1_jnt/spine2_jnt/spine3_jnt/spine4_phys/spine4_jnt/tail1_phys"),
                        new AttachableParasite(TechType.GhostRayBlue, 0.5f),
                        new AttachableParasite(TechType.Mesmer, 2f),
                        new AttachableParasite(TechType.CaveCrawler, 2f),
                        new AttachableParasite(TechType.Jumper, 2f),
