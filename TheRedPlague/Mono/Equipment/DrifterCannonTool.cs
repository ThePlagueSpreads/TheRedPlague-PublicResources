...
public class DrifterCannonTool : PlayerTool
{
    ...
    public float healthConsumption = 6;
    ...
    {
        var projectile = Instantiate(projectilePrefab, projectileSpawnPoint.position + MainCamera.camera.transform.forward * spawnDistance,
            Quaternion.identity);
    ...
    private void ExpendAmmo()
    {
        ...
        PlagueDamageStat.main.TakeInfectionDamage(3);
        UpdateMaterials();
    }
