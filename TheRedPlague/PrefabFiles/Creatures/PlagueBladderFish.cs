...
public class PlagueBladderFish : CreatureAsset
{
    public PlagueBladderFish(PrefabInfo prefabInfo) : base(prefabInfo)
    {
    }
    ...
    protected override void PostRegister()
    {
        ...
        ZombieManager.RegisterPlagueVariantConversion(TechType.Bladderfish, TechType);
    }

    protected override CreatureTemplate CreateTemplate()
    {
        var template = new CreatureTemplate(() => Plugin.CreaturesBundle.LoadAsset<GameObject>("PlagueBladder_Prefab"),
            BehaviourType.Shark, EcoTargetType.Shark, 300)
        {
            CanBeInfected = false,
            ...
            {
                new(EcoTargetType.Shark, 1.5f, 12, 1)
            },
